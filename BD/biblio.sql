...
CREATE TABLE `prestamos` (
  ...
  PRIMARY KEY (`id`),
  FOREIGN KEY (`claveLibro`) REFERENCES `libros` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY (`claveUsuario`) REFERENCES `usuarios` (`clave`) ON DELETE CASCADE ON UPDATE CASCADE
);

insert into libros (id, isbn, titulo, autor, disponible) 
  values (1, 333, 'Programacion en java', 'Luis Joyanes' , 1),
